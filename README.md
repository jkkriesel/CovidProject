...
I am using SQL to write queries and then using Tableau Public to show that data, but as I have Tableau Public I am unable to display my workbooks, so I will instead explain 
my process of using Tableau in a file posted on my respository along with the queries that were used.

I am currently in the process of learning Python(NumPY, Pandas, Matplotlib), so eventually I will include those tools in my covid project.
